...
labeltypes = ["motion_primitives", "gestures"]



# Process arguments from command line
# returns set and labeltype
...
#         if labeltype not in ["motion_primitives", "gestures"]:
#             print("Please choose label type: motion_primitives gestures")
#             sys.exit()
#     except:
#         print("Please choose label type: motion_primitives gestures")
#         sys.exit()
...
def getStats(tasks, labeltype, durations, instances):
    ...
    for task in tasks:
        ...
        for file in os.listdir(taskDir):
            ...
            if labeltype == "motion_primitives":
                tg = pd.read_table(fileIn) #, sep="\s")
            elif labeltype == "gestures":
...
if __name__ == "__main__":
    ...
    durationsMP = {"Grasp": [], "Release": [], "Touch": [], "Untouch": [], "Pull": [], "Push": []}
