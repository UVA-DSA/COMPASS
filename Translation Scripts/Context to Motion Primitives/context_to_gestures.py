...
#
# Convert context transcripts to gestures
#
# 2/8/2022 Updates:
...
#
# 6/22/2022
# Modifying context to MP conversion to do context to gesture directly
#
...
def labelMPs(npGrouped):
    ...
    for g in range(len(npGrouped)-1):
        ...
        #print(' '.join(MPs) + " " + str(npGrouped[g, 2]) + " " + str(npGrouped[g+1, 2]))
        ...
        if len(MPs) < 3:
            ...
            print(" ".join(MPs[:2]) + " " + "".join(currState)+ " " + "".join(nextState))
            print(" ".join(MPs[2:]))
        #print("\n")
        MPList.append(MPs)
    print("\n")
...
# Look at context and determine the gesture (and L/R side)
def labelGs(npGrouped):
    #print(npGrouped)
    # G transcript
    GList = []

    # entry flag (allow G1, G5, G8 at beginning)
    entry = 1
    currStart = 0
    currStop = 0

    # count G6 cycles in S and NP:
    G6s = 0
    # count G15 cycles in KT:
    G15s = 0
    ...
    for g in range(len(npGrouped)-1):
        ...
        # list of Gs for this segment which will be written to the G transcript .txt file
        Gs = [str(npGrouped[g,0]), str(npGrouped[g, 1]+timeStep-1)]  # start with start and end frames
        #print(' '.join(MPs) + " " + str(npGrouped[g, 2]) + " " + str(npGrouped[g+1, 2]))
        ...
        currStop = npGrouped[g,1]+timeStep-1


        # task-specific changes
        # Suturing or Needle_Passing
        if (task == "Suturing") or (task == "Needle_Passing"):
            # G1, G5, and G8 first
            if (entry == 1):

                # G1(R, Needle)
                #if ((currState == "00000") and (nextState in ["00200", "00020"])) or ((currState == "00020") and (nextState == "00200")):
                #if ((currState == "00202") and (nextState == "00200")) or ((currState == "00002") and (nextState == "00202")) or ((currState == "00022") and (nextState == "00202")):
                if ((currState == "00202") and (nextState == "00200")) or ((currState == "00020") and (nextState == "00200")) or ((currState == "00000") and (nextState == "00200")):
                    Gs[0] = str(currStart)
                    Gs[1] = str(currStop)
                    currStart = currStop+1
                    Gs.append("G1(R, Needle)")
                    #print("G1 found")
                    #print(Gs)

                # G5(R, Needle)
                #if ((currState == "00200") and (nextState in ["20200", "02200"])) or ((currState == "20200") and (nextState == "02200")):
                #if ((currState == "00200") and (nextState == "20200")) or ((currState == "00202") and (nextState == "00200")):
                if ((currState == "00200") and (nextState == "20200")) or ((currState == "00200") and (nextState == "02200")) or ((currState == "02200") and (nextState == "00200")) or ((currState == "02200") and (nextState == "20200")):
                    Gs[0] = str(currStart)
                    Gs[1] = str(currStop)
                    currStart = currStop+1
                    Gs.append("G5(R, Needle)") #Gs.append("G5(R, Needle)")
                    #print("G5 found")
                    #print(Gs)

                # G8(LR, Needle)
                if ((currState == "20200") and (nextState == "00200")) or ((currState == "02200") and (nextState == "00200")):
                    Gs[0] = str(currStart)
                    Gs[1] = str(currStop)
                    currStart = currStop+1
                    Gs.append("G4(LR, Needle)") #Gs.append("G8(LR, Needle)")
                    #print("G8 found")
                    #print(Gs)

                # G2(R, Needle)
                #if ((currState in ["00200", "50200", "05200", "50200"]) and (nextState in ["00201", "50201", "05201", "50201"])):
                #if ((currState == "00201") and (nextState == "00202")) or ((currState == "00200") and (nextState == "00201")) or ((currState == "03200") and (nextState == "00200")):
                #if ((currState == "00200") and (nextState == "00202")) or ((currState == "00201") and (nextState == "00202")):
                if ((currState[2] == "2") and (nextState[2] == "2") and (currState[4]=="0") and (nextState[4]=="2")) or ((currState[2] == "2") and (nextState[2] == "2") and (currState[4]=="1") and (nextState[4]=="2")):
                    Gs[0] = str(currStart)
                    Gs[1] = str(currStop)
                    currStart = currStop+1
                    Gs.append("G2(R, Needle)")
                    #print("G2 found")
                    #print(Gs)
                    entry=0
            ...
            if (entry == 0):
                # G3(R, Needle)
                #if ((currState in ["20202", "20052"]) and (nextState in ["20022", "20002"])):
                #if ((currState == "00202") and (nextState == "20022")) or ((currState == "00202") and (nextState == "20202")) or ((currState == "00242") and (nextState == "20242")):
                if ((currState == "00202") and (nextState == "02202")) or ((currState == "00202") and (nextState == "20202")):
                    Gs[0] = str(currStart)
                    Gs[1] = str(currStop)
                    currStart = currStop+1
                    Gs.append("G3(R, Needle)")
                    #print("G3 found")
                    #print(Gs)

                # G6(L, Needle)
                #if ((currState in ["20002", "20052", "20502"]) and (nextState in ["20000", "20050", "20500"])):
                if ((currState == "20002") and (nextState == "20000")):
                    Gs[0] = str(currStart)
                    Gs[1] = str(currStop)
                    currStart = currStop+1
                    Gs.append("G6(L, Needle)")
                    G6s = G6s + 1
                    #print("G6 found")
                    #print(Gs)

                # G4(LR, Needle)
                #if ((currState == "20200") and (nextState == "00200")):
                if ((currState == "20200") and (nextState == "00200")) or ((currState == "02200") and (nextState == "00200")):
                    Gs[0] = str(currStart)
                    Gs[1] = str(currStop)
                    currStart = currStop+1
                    Gs.append("G4(LR, Needle)") #Gs.append("G4(LR, Needle)")
                    #print("G4 found")
                    #print(Gs)
        ...
        if (task == "Knot_Tying"):
            ...
            if (entry == 1):
                ...
                # G1(R, Thread)
                if ((currState == "00000") and (nextState == "00300")) or ((currState == "00000") and (nextState == "00030")):
                    Gs[0] = str(currStart)
                    Gs[1] = str(currStop)
                    currStart = currStop+1
                    Gs.append("G1(R, Thread)")
                    #print("G1 found")
                    #print(Gs)

                # G12(L, Thread)
                if ((currState[0] == currState[1] == nextState[0] == "0") and (nextState[1] == "3")) or ((currState[0] == currState[1] == nextState[1] == "0") and (nextState[0] == "3")):
                    Gs[0] = str(currStart)
                    Gs[1] = str(currStop)
                    currStart = currStop+1
                    Gs.append("G12(L, Thread)")
                    #print("G2 found")
                    #print(Gs)
                    entry=0
            ...
            if (entry == 0):
                # G13(LR, Thread)
                if ((currState[4] == "0") and (nextState[4] == "1")):
                    Gs[0] = str(currStart)
                    Gs[1] = str(currStop)
                    currStart = currStop+1
                    Gs.append("G13(LR, Thread)")
                    #print("G3 found")
                    #print(Gs)

                # G14(R, Thread)  # same as G1??
                if ((currState[2] == currState[3] == nextState[2] == "0") and (currState[4] == nextState[4] == "1") and (nextState[3] == "3")) or ((currState[2] == currState[3] == nextState[3] == "0") and (currState[4] == nextState[4] == "1") and (nextState[2] == "3")):
                    Gs[0] = str(currStart)
                    Gs[1] = str(currStop)
                    currStart = currStop+1
                    Gs.append("G14(R, Thread)")
                    #print("G14 found")
                    #print(Gs)


                # G15(LR, Thread)
                if ((currState[4] == "3") and (nextState[4] == "0")):
                    Gs[0] = str(currStart)
                    Gs[1] = str(currStop)
                    currStart = currStop+1
                    Gs.append("G15(LR, Thread)")
                    G15s = G15s + 1
                    #print("G2 found")
                    #print(Gs)
        ...
        #print(Gs)
        # If no gesture was found, print an error message with the un-translated frames
        # if len(Gs) < 3:
        #     print("Help! No gesture found.")
        #     print(Gs)
        #     print("".join(currState) + " " + "".join(nextState))
        # elif len(Gs) > 3:
        #     print(" ".join(Gs[:2]) + " " + "".join(currState)+ " " + "".join(nextState))
        #     print(" ".join(Gs[2:]))
        # #print("\n")
        if len(Gs) == 3:
            GList.append(Gs)
...
gDir = os.path.join(taskDir, "motion_primitives_baseline")
...
for transcript in transcripts:  #[0:5]:   #[0:1]:
    ...
    with open(transcript, 'r') as t:
        ...
        # label gestures
        npGs = labelGs(npGrouped)
        print("\n")


        outG = os.path.join(gDir, trial)
        with open(outG, 'w') as o:
            header = ["Start", "Stop", "Gesture"]
            o.write(' '.join(header) + '\n')
            for n in npGs:
                o.write(' '.join(n))
                o.write('\n')
