# Kay Hutchinson
# 1/13/2022
# Translate MPs to JIGSAWS suturing gestures

# Run in terminal: python3 motion_primitives_to_gestures_suturing.py
...
G9 = ["Touch(R, Thread)", "Grasp(R, Thread)", "Release(R, Thread)", "Untouch(R, Thread)"]
...
taskDir = os.path.join(baseDir, "Datasets", "dV", "Suturing")
mpDir = os.path.join(taskDir, "motion_primitives")
gestureDir = os.path.join(taskDir, "gestures")
JIGSAWSDir = "/home/kay/Documents/Research/JIGSAWS_Dataset/Suturing/transcriptions"
